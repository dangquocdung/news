...
class FrontendHomeController extends Controller
{
        ...
        if (count((array)$WebmasterSection1) > 0) {
            ...
            if (count((array)$WebmasterSection2) > 0) {
                ...
                if (count((array)$Section) > 0) {
                    ...
                    $Topic = Topic::where('status', 1)->where('id', $id)->first();
    ...
    public function DanhBaDienThoai()
    {

        
        $PageTitle = 'Danh bạ điện thoại';
        $PageDescription = 'Danh bạ điện thoại';
        $PageKeywords = 'Danh bạ điện thoại';
    ...
    public function Vaccine()
    {
        ...
        $PageTitle = 'Vaccine hiện có';
        $PageDescription = 'Vaccine hiện có';
        $PageKeywords = 'Vaccine hiện có';
    ...
    public function panoLens($id,$slug=""){
