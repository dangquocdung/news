                ...
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if (Auth::user()->permissions_id < 3)
                            ...
                            <div class="form-group row">
                                <label for="link_status"
                                        class="col-sm-2 form-control-label">{!!  trans('backLang.thongbao') !!}</label>
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                    ...
                                    @foreach($Topics->photos as $photo)
                                        <div class="col-xs-6 col-sm-4 col-md-3">
                                            <div class="box p-a-xs">
                                                ...
                                                {!! Form::textarea('description_'.$photo->id,$photo->description, array('class' => 'pull-left form-control','rows' => '3','id'=>'description','style'=>'font-size:12px; margin-bottom: 5px')) !!}
