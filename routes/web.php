...
// ../panolens
Route::get('/hinh-anh-360/{slug}-{id}', 'FrontendHomeController@panoLens')->name('panoLens');
...
// ..Calendar
Route::get('/lich-cong-tac', 'FrontendHomeController@LichCongTac');

// ..Calendar
Route::get('/danh-ba-dien-thoai', 'FrontendHomeController@DanhBaDienThoai');

// ..Calendar
Route::get('/vac-xin-hien-co', 'FrontendHomeController@Vaccine');
